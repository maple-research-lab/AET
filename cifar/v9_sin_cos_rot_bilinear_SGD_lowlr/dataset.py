...
#        matrix = torch.from_numpy(np.array(matrix, np.float32, copy=False))
        
        aff_para = [math.cos(math.radians(ret[0])),
                    math.sin(math.radians(ret[0])),
                    #ret[0]*2./(self.degrees[1]-self.degrees[0])-(self.degrees[0]+self.degrees[1])/(self.degrees[1]-self.degrees[0]),
