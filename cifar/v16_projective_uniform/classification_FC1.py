...
def main():
    ...
    model = Classifier(_nChannels=192*8*8, _num_classes=10, _cls_type='MultLayerFC1').to(device)
#    model = Classifier(_nChannels=192, _num_classes=10, _cls_type='NIN_ConvBlock3').to(device)
