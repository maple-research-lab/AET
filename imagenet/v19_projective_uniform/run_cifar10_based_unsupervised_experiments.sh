...
CUDA_VISIBLE_DEVICES=2 python main.py --exp=CIFAR10_RotNet_NIN4blocks
...
CUDA_VISIBLE_DEVICES=2 python main.py --exp=CIFAR10_MultLayerClassifier_on_RotNet_NIN4blocks_Conv2_feats
